<div>
    ...
    <span class="flex pb-2">
        <input wire:model.live="labName" wire:keydown.enter="updateLabName" class=" shadow mr-2 appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" x-model="lab.name">
