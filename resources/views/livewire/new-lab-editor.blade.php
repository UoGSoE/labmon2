<div>
    ...
    <span class="flex pb-2">
        ...
        <input wire:model="labName" wire:keydown.enter="saveLab" class=" shadow appearance-none mr-2 border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="labName" type="text" placeholder="Lab name...">
        ...
        {{-- <input wire:model="school" wire:keydown.enter="saveLab" class=" shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="school" type="text" placeholder="School name..."> --}}
